...
export const CATEGORY_OPTIONS = [
  ...
  { value: 'Association d\'idées', label: 'Association d\'idées' },
  { value: 'Aventure', label: 'Aventure' },
  { value: 'Bluff', label: 'Bluff' },
  { value: 'Chance', label: 'Chance' },
  { value: 'Connaissances', label: 'Connaissances' },
  { value: 'Coopératif', label: 'Coopératif' },
  { value: 'Dés', label: 'Dés' },
  { value: 'Guess', label: 'Guess' },
  { value: 'Jeu de cartes', label: 'Jeu de cartes' },
  { value: 'Jeu de plateau', label: 'Jeu de plateau' },
  { value: 'Jeu de plis', label: 'Jeu de plis' },
  { value: 'Mémoire', label: 'Mémoire' },
  { value: 'Observation', label: 'Observation' },
  { value: 'Par équipe', label: 'Par équipe' },
  { value: 'Rapidité', label: 'Rapidité' },
  { value: 'Stratégie / Planification', label: 'Stratégie / Planification' },
...
export const MECHANICS_OPTIONS = [
  ...
  { value: 'Legacy / Campagne', label: 'Legacy / Campagne' },
